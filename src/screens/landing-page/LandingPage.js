        ...
        <Layout>
            <VStack sx={{width: "100%"}}>
                <HStack justifyContent={'flex-start'}>
                    <Typography sx={styles.headerSectionTitle}>Check personalised benefits and financial support</Typography>
                </HStack>
                <HStack>
                    <Card sx={styles.headerSectionButtonCard}>
                        <Link to={'/onboarding-choice'} style={{textDecoration: 'none', color: "black", width: '100%'}}>

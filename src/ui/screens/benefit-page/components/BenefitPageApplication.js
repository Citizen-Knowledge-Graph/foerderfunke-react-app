...
<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:color="http://www.omg.org/spec/BPMN/non-normative/color/1.0" id="Defs_gsi_lane_centered_simple_even" targetNamespace="https://example.org/bpmn#" exporter="bpmn-js (https://demo.bpmn.io)" exporterVersion="18.6.1">
  <bpmn:process id="p_gsi_simple" isExecutable="false">
    <bpmn:laneSet id="ls_gsi">
      <bpmn:lane id="lane_agency" name="Sozialamt/Grundsicherungsamt">
    ...
    <bpmn:manualTask id="t0" name="Grundsicherung beantragen">
    ...
    <bpmn:sendTask id="t3" name="Bescheid zuschicken">
  ...
  <bpmndi:BPMNDiagram id="D_gsi_simple_even">
    <bpmndi:BPMNPlane id="P_gsi_simple_even" bpmnElement="p_gsi_simple">
      <bpmndi:BPMNShape id="L_user" bpmnElement="lane_user" isHorizontal="true" color:background-color="#F6FFF6" color:border-color="#A3A3A3">
        <dc:Bounds x="150" y="80" width="1260" height="120" />
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="L_agency" bpmnElement="lane_agency" isHorizontal="true" color:background-color="#F5F8FF" color:border-color="#A3A3A3">
        <dc:Bounds x="150" y="200" width="1260" height="160" />
      </bpmndi:BPMNShape>
      ...
      <bpmndi:BPMNShape id="Deno" bpmnElement="e_no" color:background-color="#FEF2F2" color:border-color="#B91C1C">
        ...
        <bpmndi:BPMNLabel>
          <dc:Bounds x="1305" y="158" width="50" height="14" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>
      <bpmndi:BPMNShape id="Deok" bpmnElement="e_ok" color:background-color="#ECFDF5" color:border-color="#059669">
        <dc:Bounds x="1312" y="262" width="36" height="36" />
        <bpmndi:BPMNLabel>
          <dc:Bounds x="1310" y="298" width="41" height="14" />
        </bpmndi:BPMNLabel>
      </bpmndi:BPMNShape>

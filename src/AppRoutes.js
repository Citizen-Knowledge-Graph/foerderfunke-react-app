...
import OnboardingChoiceEntityType from './ui/screens/onboarding-choice/OnboardingChoiceEntityType';
...
const AppRoutes = () => (
    <Routes>
        ...
        <Route path="/entity-choice" element={<OnboardingChoiceEntityType/>}/>
    </Routes>
);
